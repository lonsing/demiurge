...
COMMAND="../tool/build/src/demiurge-bin -r -b learn -m 10 --print=L"
...
TIMESTAMP=`date +%s`
RES_TXT_FILE="${DIR}results/results_Q10_${TIMESTAMP}.txt"
RES_DIR="${DIR}results/results_Q10_${TIMESTAMP}/"
mkdir -p "${DIR}results/"
mkdir -p ${RES_DIR}
