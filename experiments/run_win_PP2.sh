...
COMMAND="../tool/build/src/demiurge-bin -r -b lp2 -m 1 -s min_api --print=L"
...
TIMESTAMP=`date +%s`
RES_TXT_FILE="${DIR}results/results_PP2_${TIMESTAMP}.txt"
RES_DIR="${DIR}results/results_PP2_${TIMESTAMP}/"
mkdir -p "${DIR}results/"
mkdir -p ${RES_DIR}
