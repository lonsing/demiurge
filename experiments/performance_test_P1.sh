...
COMMAND="../tool/build/src/demiurge-bin -r -b lp1 -m 1 -s lin_api --print=L"
...
TIMESTAMP=`date +%s`
RES_TXT_FILE="${DIR}results/results_P1_${TIMESTAMP}.txt"
RES_DIR="${DIR}results/results_P1_${TIMESTAMP}/"
mkdir -p "${DIR}results/"
mkdir -p ${RES_DIR}
