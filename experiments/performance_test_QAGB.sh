...
COMMAND="../tool/build/src/demiurge-bin -r -b learn -m 5 -q blo_dep_api --print=L"
...
TIMESTAMP=`date +%s`
RES_TXT_FILE="${DIR}results/results_QAGB_${TIMESTAMP}.txt"
RES_DIR="${DIR}results/results_QAGB_${TIMESTAMP}/"
mkdir -p "${DIR}results/"
mkdir -p ${RES_DIR}
