...
COMMAND="../tool/build/src/demiurge-bin -r -b lp3 -m 0 -s min_api --print=L"
...
TIMESTAMP=`date +%s`
RES_TXT_FILE="${DIR}results/results_P3_${TIMESTAMP}.txt"
RES_DIR="${DIR}results/results_P3_${TIMESTAMP}/"
mkdir -p "${DIR}results/"
mkdir -p ${RES_DIR}
