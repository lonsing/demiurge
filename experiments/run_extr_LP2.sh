...
COMMAND="../tool/build/src/demiurge-bin -b load -s lin_api -c lp2 -k 10000 --print=DERWIL"
...
TIMESTAMP=`date +%s`
RES_TXT_FILE="${DIR}results/results_extr_LP2_${TIMESTAMP}.txt"
RES_DIR="${DIR}results/results_extr_LP2_${TIMESTAMP}/"
mkdir -p "${DIR}results/"
mkdir -p ${RES_DIR}
