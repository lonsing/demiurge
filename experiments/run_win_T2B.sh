...
COMMAND="../tool/build/src/demiurge-bin -r -b templ -m 2 -q blo_dep_api --print=L"
...
TIMESTAMP=`date +%s`
RES_TXT_FILE="${DIR}results/results_T2B_${TIMESTAMP}.txt"
RES_DIR="${DIR}results/results_T2B_${TIMESTAMP}/"
mkdir -p "${DIR}results/"
mkdir -p ${RES_DIR}
