\hypertarget{classStoreImplExtractor}{\section{Store\-Impl\-Extractor Class Reference}
\label{classStoreImplExtractor}\index{Store\-Impl\-Extractor@{Store\-Impl\-Extractor}}
}
...
\hypertarget{classStoreImplExtractor_ab52feee236cb70953d9723c676601fb1}{\index{Store\-Impl\-Extractor@{Store\-Impl\-Extractor}!Store\-Impl\-Extractor@{Store\-Impl\-Extractor}}
\index{Store\-Impl\-Extractor@{Store\-Impl\-Extractor}!StoreImplExtractor@{Store\-Impl\-Extractor}}
\subsubsection[{Store\-Impl\-Extractor}]{\setlength{\rightskip}{0pt plus 5cm}Store\-Impl\-Extractor\-::\-Store\-Impl\-Extractor (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)}}\label{classStoreImplExtractor_ab52feee236cb70953d9723c676601fb1}
...
Definition at line 37 of file Store\-Impl\-Extractor.\-cpp.

\hypertarget{classStoreImplExtractor_ad617c7ffdeee1ddaec668b55deb4dc03}{\index{Store\-Impl\-Extractor@{Store\-Impl\-Extractor}!$\sim$\-Store\-Impl\-Extractor@{$\sim$\-Store\-Impl\-Extractor}}
\index{$\sim$\-Store\-Impl\-Extractor@{$\sim$\-Store\-Impl\-Extractor}!StoreImplExtractor@{Store\-Impl\-Extractor}}
\subsubsection[{$\sim$\-Store\-Impl\-Extractor}]{\setlength{\rightskip}{0pt plus 5cm}Store\-Impl\-Extractor\-::$\sim$\-Store\-Impl\-Extractor (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [virtual]}}}\label{classStoreImplExtractor_ad617c7ffdeee1ddaec668b55deb4dc03}
...
Definition at line 43 of file Store\-Impl\-Extractor.\-cpp.

\hypertarget{classStoreImplExtractor_a5389fb6de2bf4e5e813ab2bf4dc23e90}{\index{Store\-Impl\-Extractor@{Store\-Impl\-Extractor}!Store\-Impl\-Extractor@{Store\-Impl\-Extractor}}
\index{Store\-Impl\-Extractor@{Store\-Impl\-Extractor}!StoreImplExtractor@{Store\-Impl\-Extractor}}
\subsubsection[{Store\-Impl\-Extractor}]{\setlength{\rightskip}{0pt plus 5cm}Store\-Impl\-Extractor\-::\-Store\-Impl\-Extractor (
\begin{DoxyParamCaption}
\item[{const {\bf Store\-Impl\-Extractor} \&}]{other}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [private]}}}\label{classStoreImplExtractor_a5389fb6de2bf4e5e813ab2bf4dc23e90}
...
\hypertarget{classStoreImplExtractor_a08437db801013d0b3208bbf099239fac}{\index{Store\-Impl\-Extractor@{Store\-Impl\-Extractor}!extract\-Circuit@{extract\-Circuit}}
\index{extract\-Circuit@{extract\-Circuit}!StoreImplExtractor@{Store\-Impl\-Extractor}}
\subsubsection[{extract\-Circuit}]{\setlength{\rightskip}{0pt plus 5cm}void Store\-Impl\-Extractor\-::extract\-Circuit (
\begin{DoxyParamCaption}
\item[{const {\bf C\-N\-F} \&}]{winning\-\_\-region}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [virtual]}}}\label{classStoreImplExtractor_a08437db801013d0b3208bbf099239fac}


Stores the winning region into a file. 

This method does not really extract a circuit. It only stores the winning region into a file. This method is used to save computation time when benchmarking relation determinization approaches\-: instead of computing the winning region each and every time, we simply store it into a file and load it from there again.


\begin{DoxyParams}{Parameters}
{\em winning\-\_\-region} & The winning region to store. \\
\hline
\end{DoxyParams}


Reimplemented from \hyperlink{classCNFImplExtractor_ad329eedd50e443f44edc99db8c2e2613}{C\-N\-F\-Impl\-Extractor}.



Definition at line 49 of file Store\-Impl\-Extractor.\-cpp.



References Options\-::get\-Aig\-In\-File\-Name\-Only(), Options\-::instance(), M\-A\-S\-S\-E\-R\-T, and C\-N\-F\-::save\-To\-File().

\hypertarget{classCNFImplExtractor_a5e9694425af3f1a76d8b21ace3c435d9}{\index{Store\-Impl\-Extractor@{Store\-Impl\-Extractor}!extract\-Circuit@{extract\-Circuit}}
\index{extract\-Circuit@{extract\-Circuit}!StoreImplExtractor@{Store\-Impl\-Extractor}}
...
\hypertarget{classCNFImplExtractor_a0970602635f3356712d57ebb28d12c0d}{\index{Store\-Impl\-Extractor@{Store\-Impl\-Extractor}!insert\-Into\-Spec@{insert\-Into\-Spec}}
\index{insert\-Into\-Spec@{insert\-Into\-Spec}!StoreImplExtractor@{Store\-Impl\-Extractor}}
...
\hypertarget{classCNFImplExtractor_abe790c767f6c71a52ef8b0a61ab39eaa}{\index{Store\-Impl\-Extractor@{Store\-Impl\-Extractor}!log\-Detailed\-Statistics@{log\-Detailed\-Statistics}}
\index{log\-Detailed\-Statistics@{log\-Detailed\-Statistics}!StoreImplExtractor@{Store\-Impl\-Extractor}}
...
\hypertarget{classCNFImplExtractor_aae098749e201b22294a70f6e0a4a58f0}{\index{Store\-Impl\-Extractor@{Store\-Impl\-Extractor}!log\-Statistics@{log\-Statistics}}
\index{log\-Statistics@{log\-Statistics}!StoreImplExtractor@{Store\-Impl\-Extractor}}
...
\hypertarget{classStoreImplExtractor_a331227d3a6c7bd37a1bdf79346974166}{\index{Store\-Impl\-Extractor@{Store\-Impl\-Extractor}!operator=@{operator=}}
\index{operator=@{operator=}!StoreImplExtractor@{Store\-Impl\-Extractor}}
\subsubsection[{operator=}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Store\-Impl\-Extractor}\& Store\-Impl\-Extractor\-::operator= (
\begin{DoxyParamCaption}
\item[{const {\bf Store\-Impl\-Extractor} \&}]{other}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [private]}}}\label{classStoreImplExtractor_a331227d3a6c7bd37a1bdf79346974166}
...
\end{DoxyReturn}
\hypertarget{classCNFImplExtractor_a58a4e5021d0ef9c4190a5be74fb5a83e}{\index{Store\-Impl\-Extractor@{Store\-Impl\-Extractor}!optimize\-With\-A\-B\-C@{optimize\-With\-A\-B\-C}}
\index{optimize\-With\-A\-B\-C@{optimize\-With\-A\-B\-C}!StoreImplExtractor@{Store\-Impl\-Extractor}}
...
\hypertarget{classStoreImplExtractor_a69c775e70973cbd4b6a69775f25367cd}{\index{Store\-Impl\-Extractor@{Store\-Impl\-Extractor}!run@{run}}
\index{run@{run}!StoreImplExtractor@{Store\-Impl\-Extractor}}
\subsubsection[{run}]{\setlength{\rightskip}{0pt plus 5cm}void Store\-Impl\-Extractor\-::run (
\begin{DoxyParamCaption}
\item[{const {\bf C\-N\-F} \&}]{winning\-\_\-region, }
\item[{const {\bf C\-N\-F} \&}]{neg\-\_\-winning\-\_\-region}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [protected]}, {\ttfamily [virtual]}}}\label{classStoreImplExtractor_a69c775e70973cbd4b6a69775f25367cd}
...
Definition at line 64 of file Store\-Impl\-Extractor.\-cpp.



\subsection{Member Data Documentation}
\hypertarget{classCNFImplExtractor_ab8be06d42fd3c4b569ec22cfcf2f508e}{\index{Store\-Impl\-Extractor@{Store\-Impl\-Extractor}!extraction\-\_\-cpu\-\_\-time\-\_\-@{extraction\-\_\-cpu\-\_\-time\-\_\-}}
\index{extraction\-\_\-cpu\-\_\-time\-\_\-@{extraction\-\_\-cpu\-\_\-time\-\_\-}!StoreImplExtractor@{Store\-Impl\-Extractor}}
...
\hypertarget{classCNFImplExtractor_ae06413cf08f868357d64545b3041aa18}{\index{Store\-Impl\-Extractor@{Store\-Impl\-Extractor}!extraction\-\_\-real\-\_\-time\-\_\-@{extraction\-\_\-real\-\_\-time\-\_\-}}
\index{extraction\-\_\-real\-\_\-time\-\_\-@{extraction\-\_\-real\-\_\-time\-\_\-}!StoreImplExtractor@{Store\-Impl\-Extractor}}
