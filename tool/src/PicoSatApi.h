...
// -------------------------------------------------------------------------------------------
/// @file PicoSatApi.h
/// @brief Contains the declaration of the class PicoSatApi.
// -------------------------------------------------------------------------------------------

#ifndef PicoSatApi_H__
#define PicoSatApi_H__
...
///
/// @class PicoSatApi
/// @brief Interfaces the PicoSat SAT-solver via its API.
///
/// This class represents an interface to the SAT-solver PicoSat (see
/// http://fmv.jku.at/picosat/). It is a concrete implementation of the SatSolver
...
///        calls slower but produces potentially smaller cubes.
  PicoSatApi(bool rand_models = false, bool min_cores = true);
...
///        vector. The PicoSatApi actually completely ignores these variables. However, other
...
///        computed.
/// @param ass Additional assumptions under which the CNF should be solved. This can
...
///        after this method is done.
  void randModel(PicoSAT *solver, const vector<int> &ass, vector<int> &model);

// -------------------------------------------------------------------------------------------
///
/// @brief The incremental solver instance.
///
/// We do not need a stack but only one instance here, because PicoSAT supports push and
/// and pop natively.
  PicoSAT *incr_;
...
/// @param other The source for creating the copy.
  PicoSatApi(const PicoSatApi &other);
...
/// @return The result of the assignment, i.e, *this.
  PicoSatApi& operator=(const PicoSatApi &other);

};

#endif // PicoSatApi_H__
